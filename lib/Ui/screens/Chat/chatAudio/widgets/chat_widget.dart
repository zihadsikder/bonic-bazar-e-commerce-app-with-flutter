      ...
      child: Padding(
        ...
        child: Container(
          ...
          margin: EdgeInsets.only(
            ...
            right: widget.senderId.toString() == HiveUtils.getUserId() ? 20 : 0,
            left: widget.senderId.toString() == HiveUtils.getUserId() ? 0 : 20,
          ),
          child: Column(
            crossAxisAlignment: widget.senderId.toString() == HiveUtils.getUserId()
                                    ...
                                    TextSpan(
                                      ...
                                      children: _replaceLink().map((data) {
                                        ...
                                        return TextSpan(
                                          ...
                                          style: TextStyle(
                                              color: widget.senderId.toString() ==
                                                      HiveUtils.getUserId()
                                                  ? context.color.secondaryColor
                                                  : context
                                                      .color.textColorDark),
