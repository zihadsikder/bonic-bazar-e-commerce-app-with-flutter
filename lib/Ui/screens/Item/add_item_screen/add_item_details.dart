                ...
                child: UiUtils.buildButton(context, onPressed: () {
                  ...
                  if (_formKey.currentState?.validate() ?? false) {
                    ...
                    addCloudData("item_details", {
                      ...
                      "additional": adAdditionalDetailsController.text,
                      if (widget.isEdit == true)
                        "delete_item_image_id": deleteItemImageList.join(','),
                      "all_category_ids": widget.isEdit == true ? item!
                          .allCategoryIds : selectedCategoryList.join(',')
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("additionals".translate(context)),
                      SizedBox(
                        height: 10.rh(context),
                      ),
                      CustomTextFormField(
            ...
            DottedBorder(
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  _pickTitleImage.pick(pickMultiple: false, context: context);
